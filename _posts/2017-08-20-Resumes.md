...
I will use this project to teach you how a computer “thinks.” I hope that this article may enlighten you about how machine learning works.

<!--end_summary-->

<img style="float: right; margin-left:10px; margin-top:-5px;" src="/resources/fixing-unplugged-computer-clipart_750-754.png" width=275 height=275 alt="https://clipartfest.com/download/bb6ad6c6ec516c0883d3f33d885b02cca169f21b.html"/>
...
<img style="float: left; margin-right:10px;" src="/resources/k19403833.png" width=200 height=200 alt="Resume clip-art"/>
...
<img style="float: right; margin-left:10px; margin-bottom:10px;" src="/resources/1252997748713475.jpeg" width=350 height=350 alt="http://www.okclipart.com/Scrabble-Players-Clip-Art30khensaze/"/>
...
<img style="float: center; margin-bottom:10px;" src="/resources/PCA.png" width=600 height=200 alt="PCA demonstration" title="http://setosa.io/ev/principal-component-analysis/"/>
...
<img style="float: right; margin-left:10px; margin-bottom:10px;" src="/resources/ExplainedVariance.png" width=415 height=415 alt="graph of variance from each new component"/>
...
<img style="float: center; margin-bottom:10px;" src="/resources/output.png" alt="final output"/>
...
(shared with permission from Chris Brinton, CEO of Mosaic Data Science)